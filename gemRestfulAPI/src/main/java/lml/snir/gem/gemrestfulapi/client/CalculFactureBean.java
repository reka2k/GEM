...
//        facture += this.CTA * 1.055;
    ...
    public void calculFactureJour() {

       if (typeContrat.contains("tempo")) calculFactureJourTempo(date);
           
       if (typeContrat.contains("hchp")) calculFactureJourHPHC(date);
       
       if (typeContrat.contains("base")) calculFactureJourBase(date);
