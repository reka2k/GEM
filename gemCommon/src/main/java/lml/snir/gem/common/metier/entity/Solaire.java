...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Solaire.findAll", query = "SELECT s FROM Solaire s"),
    @NamedQuery(name = "Solaire.findById", query = "SELECT s FROM Solaire s WHERE s.id = :id"),
    @NamedQuery(name = "Solaire.findByConso", query = "SELECT s FROM Solaire s WHERE s.conso = :conso"),
    @NamedQuery(name = "Solaire.findByBatteryCapacity", query = "SELECT s FROM Solaire s WHERE s.batteryCapacity = :batteryCapacity"),
    @NamedQuery(name = "Solaire.findByBatteryVoltage", query = "SELECT s FROM Solaire s WHERE s.batteryVoltage = :batteryVoltage"),
    @NamedQuery(name = "Solaire.findByPVPower", query = "SELECT s FROM Solaire s WHERE s.pVPower = :pVPower"),
    @NamedQuery(name = "Solaire.findByOutputSourcePriority", query = "SELECT s FROM Solaire s WHERE s.outputSourcePriority = :outputSourcePriority"),
    @NamedQuery(name = "Solaire.findByChargingSourcePriority", query = "SELECT s FROM Solaire s WHERE s.chargingSourcePriority = :chargingSourcePriority"),
    @NamedQuery(name = "Solaire.findByDatetime", query = "SELECT s FROM Solaire s WHERE s.datetime = :datetime")})
